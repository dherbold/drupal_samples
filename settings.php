...
/**
 * Added include for local DB settings
 */
...
if (isset($_ENV['PANTHEON_ENVIRONMENT']) &&
  ($_SERVER['HTTP_HOST'] == 'oofsi.education.asu.edu') &&
  // Check if Drupal or WordPress is running via command line
  (php_sapi_name() != "cli")) {
  $newurl = 'https://education.asu.edu/oofsi/'. $_SERVER['REQUEST_URI'];
  header('HTTP/1.0 301 Moved Permanently');
  header("Location: $newurl");
  exit();
}
// education.asu.edu edits
...
if (isset($_SERVER['PANTHEON_ENVIRONMENT']) && php_sapi_name() != 'cli') {
  ...
  if ($_ENV['PANTHEON_ENVIRONMENT'] === 'live') {
    ...
    $primary_domain = 'education.asu.edu';
  }
  else {
...
$conf['webform_export_path'] = 'public://webform_results'; // Change to the parent directory you want